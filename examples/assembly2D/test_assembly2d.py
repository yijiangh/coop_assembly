...
from pybullet_planning import connect, has_gui, LockRenderer, remove_handles, add_line, \
    ...
    set_joint_positions, create_attachment, wait_if_gui, apply_alpha, get_movable_joints, get_links, base_values_from_pose
...
def test_stream(viewer, collision):
    end_effector = load_2d_world(viewer=viewer)
    ...
    for _ in range(n_attempts):
        ...
        ee_pose = base_values_from_pose(world_from_ee)
